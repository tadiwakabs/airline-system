CREATE TABLE `Ticket` (
      ...
      `seatNumber` char(3) DEFAULT NULL,
      `flightCode` int DEFAULT NULL,
      ...
      CONSTRAINT `fk_ticket_booking` FOREIGN KEY (`bookingId`) REFERENCES `Booking` (`bookingId`) ON DELETE RESTRICT ON UPDATE CASCADE,
      CONSTRAINT `fk_ticket_flight` FOREIGN KEY (`flightCode`) REFERENCES `Flight` (`flightNum`) ON DELETE RESTRICT ON UPDATE CASCADE,
      CONSTRAINT `fk_ticket_passenger` FOREIGN KEY (`passengerId`) REFERENCES `Passenger` (`passengerId`) ON DELETE RESTRICT ON UPDATE CASCADE,
      CONSTRAINT `fk_ticket_seating` FOREIGN KEY (`flightCode`, `seatNumber`) REFERENCES `Seating` (`flightNum`, `seatNumber`) ON DELETE RESTRICT ON UPDATE CASCADE,
