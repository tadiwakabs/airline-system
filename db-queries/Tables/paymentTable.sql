CREATE TABLE `Payment` (
       ...
       KEY `payer` (`userId`),
       CONSTRAINT `fk_payment_user` FOREIGN KEY (`userId`) REFERENCES `Users` (`userId`) ON DELETE RESTRICT ON UPDATE CASCADE,
       CONSTRAINT `uq_payment_booking` FOREIGN KEY (`bookingId`) REFERENCES `Booking` (`bookingId`) ON DELETE RESTRICT ON UPDATE CASCADE,
